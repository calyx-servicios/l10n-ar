...
class L10nArAfipwsConnection(models.Model):
    ...
    def _get_l10n_ar_afip_ws(self):
        ...
        return super()._get_l10n_ar_afip_ws() + [("A122R", _("Webservice Retenciones (A122R)"))]
    ...
    def _l10n_ar_get_token_data_arba(self, company, afip_ws):
        ...
        try:
            _logger.info(
                "Connect to ARBA to get token: %s %s %s", afip_ws, company.l10n_ar_afip_ws_crt_fname, company.name
            )
            payload = (
