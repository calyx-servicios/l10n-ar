...
class L10nArDjArba(models.Model):
    ...
    def _create_withholding(self, wh_line):
        ...
        # Las líneas creadas desde payment_group tienen payment_id=NULL.
        wh_partner = wh_line.payment_group_id.partner_id or wh_line.payment_id.partner_id
        wh_company = wh_line.payment_group_id.company_id or wh_line.payment_id.company_id
        wh_date = wh_line.payment_group_id.payment_date or wh_line.payment_id.date
        wh_doc = wh_line.payment_group_id or wh_line.payment_id
